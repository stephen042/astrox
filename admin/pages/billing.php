    ...
    <nav class="navbar navbar-main navbar-expand-lg px-0 mx-4 shadow-none border-radius-xl" id="navbarBlur" navbar-scroll="true">
      <div class="container-fluid py-1 px-3">
        <nav aria-label="breadcrumb">
          ...
          <h6 class="font-weight-bolder mb-0">Billings</h6>
        </nav>
      </div>
    </nav>
    <!-- End Navbar -->
          ...
          <div class="card my-4">
            <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
              <div class="bg-gradient-primary shadow-primary border-radius-lg pt-4 pb-3">
                <h6 class="text-white text-capitalize ps-3">Billings table</h6>
              </div>
            </div>
          ...
          <?php    if(empty($data["status"])){  ?>
            <tr>
                      ...
                      <td class="align-middle text-center text-sm">
                        <span class="badge badge-sm bg-gradient-success" style="cursor:pointer;" data-index="<?=$data["id"]?>" id="approve">Approve</span>
                        <span class="badge badge-sm bg-gradient-danger" style="cursor:pointer;" data-index="<?=$data["id"]?>" id="decline">Declined</span>
                      </td>
                      <td class="align-middle text-center">
                        <span class="text-secondary text-xs font-weight-bold"><?=date("d/M/Y",strtotime($data["created_at"]))?></span>
                      </td>
                      <td class="align-middle">
                        <a href="javascript:;" class="text-secondary font-weight-bold text-xs text-danger"id="deleteorder" data-index="<?=$data["id"]?>" data-toggle="tooltip" data-original-title="delete user">
                          Delete
                        </a>
                      </td>
                    </tr>
